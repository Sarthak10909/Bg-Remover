  ...
  return (
    <div className = 'pb-10 md:py-20 mx-2'>
        ...
        <div className = 'relative w-full max-w-3xl overflow-hidden m-auto rounded-xl'>
            {/*Background image*/}
            <img src= {asset.image_w_bg} style = {{clipPath:`inset(0 ${100.2 - sliderPosition}% 0 0 )`}} alt="" />

            {/*Foreground Image*/}
            <img className = 'absolute top-0 left-0 w-full h-full' src={asset.image_wo_bg} style = {{clipPath:`inset(0 0 0 ${sliderPosition}%)`}} alt="" />
