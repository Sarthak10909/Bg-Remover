...
const BgSlider = () => {
  ...
  return (
    <div className = 'pb-10 md:py-20 mx-2'>
        ...
        <div className = 'relative w-full max-w-3xl overflow-hidden m-auto rounded-xl' style={{ height: '600px', width: '1000px' }}>
            {/*Background image*/}
            <img  className='absolute top-0 left-0 w-full h-full' src= {asset.snipItSecond} style = {{clipPath:`inset(0 ${100.2 - sliderPosition}% 0 0 )`}} alt="" />

            {/*Foreground Image*/}
            <img className = 'absolute top-0 left-0 w-full h-full' src={asset.snipItSecondwb} style = {{clipPath:`inset(0 0 0 ${sliderPosition}%)`}} alt="" />
